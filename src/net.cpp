...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "federalreserveCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"S114785", "210.209.215.41"},
    {"S987559", "192.126.123.153"},
    {"S901090", "210.209.215.41"},
    {"S688648", "192.126.123.157"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. federalreserveCoin is probably already running."), addrBind.ToString().c_str());
        else
