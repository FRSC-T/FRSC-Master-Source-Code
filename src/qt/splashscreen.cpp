    ...
    QSplashScreen(pixmap, f)
{
    ...
    int paddingLeftCol2         = 180;
    int paddingTopCol2          = 382;
    int line1 = 0;
    int line2 = 13;
    int line3 = 26;
    int line4 = 39;
    ...
    QString copyrightText3   = QChar(0xA9)+QString(" %1-2015 ").arg(COPYRIGHT_YEAR) + QString(tr("The Federal Reserve System developers"));
